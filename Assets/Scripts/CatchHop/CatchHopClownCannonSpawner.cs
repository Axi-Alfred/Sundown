...
public class CatchHopClownCannonSpawner : MonoBehaviour
{
    ...
    void Update()
    {
        ...
        if (timer <= 0f)
        {
            ...
            // Minska intervallet för att öka svårighetsgraden
    ...
    void SpawnClown()
    {
        ...
        // Spela upp kanonens squish-animation 
        if (cannonAnimator != null)
        {
            cannonAnimator.SetTrigger("Squish ");
        }
